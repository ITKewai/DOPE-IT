...
do
    case $opt in
        "Install Dependencies")
            ...
            sudo apt install curl libssl1.0.0 libkrb5-3 zlib1g libunwind8 libuuid1 libc6 libstdc++6 libgcc1 libcurl4-gnutls-dev python-setuptools python-requests python python3-pip python-pip screen $version -y
